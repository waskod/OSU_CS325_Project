...
origNodeCount = len(origNodeList)
...
#This Section should be broken into its own section if we have time
                    ...
                    """
                    # New Code (more of it) to handle edge pair case of higher v1 number first in pair
                    if e2v1 < e1v1:
...
# ******************
                    ...
                    if(newTotal < existingTotal):
                        ...
                        print("      Creating new edges:")
                        print("      firstVertex: " + str(firstVertex))
                        print("      NodeList[FirstEdgeIndex]: " + str(NodeList[FirstEdgeIndex]) + "\n")
                        print("      secondVertex: " + str(secondVertex))
                        print("      NodeList[SecondEdgeIndex]: " + str(NodeList[SecondEdgeIndex]) + "\n")                        

                        newEdge1Str = createVtxPairFromEStrct(newEdge1)
                        print("\n      newEdge1: " + newEdge1Str)
                        ...
                        #**********************************************************************
                        # New code from Philip and myself
                        ...
                        del listofEdges[0]
                        # print("        after del, now listofEdges: ")
                        # print(listofEdges)
                        ...
                        while len(newOrderNodes) < numberOfNodes and whileCount < 20:
                        # while len(newOrderNodes) < numberOfNodes: 
                            
                            # print("\n          while: len(newOrderNodes): " + str(len(newOrderNodes)))
                            ...
                            for couple in listofEdges:
                                # print("\n             for loop for couple in listofEdges. couple: " + str(couple))
                        ...
                        # New Code: NodeList Reordering, ReWriting Section

                        for i in range(0, len(newOrderNodes)):
                            print(newOrderNodes[i])
                            currIdx = newOrderNodes[i]
                            print(origNodeList[currIdx])
                            NodeList[i] = origNodeList[currIdx]
                            print("i: " + str(i) + "  NodeList[i]: " + str(NodeList[i]) + "\n")
                            
                        print(NodeList)
                        print(newOrderNodes)
                        print("\n      After For Loop. newly reordered NodeList: ")
                        printNodeList(NodeList)
                        print("\n      After For Loop. original NodeList: ")
                        printNodeList(origNodeList)
                        ...
                        print("\n      End of Replace Section. NodeList: ")
                        printNodeList(NodeList)
